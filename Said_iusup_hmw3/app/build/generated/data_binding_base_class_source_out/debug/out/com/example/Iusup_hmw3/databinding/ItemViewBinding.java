...
public final class ItemViewBinding implements ViewBinding {
  ...
  private ItemViewBinding(@NonNull LinearLayout rootView, @NonNull TextView itemDescription,
  ...
  public static ItemViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemViewBinding((LinearLayout) rootView, itemDescription, itemImage, itemTitle);
    }
